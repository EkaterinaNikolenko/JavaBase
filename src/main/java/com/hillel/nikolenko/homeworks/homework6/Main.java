package com.hillel.nikolenko.homeworks.homework6;
...
public class Main {
    public static void main(String[] args) {
        ...
        double secondTeamAverage = (secondTeamFrag1 + secondTeamFrag2 + secondTeamFrag3 + secondTeamFrag4 + secondTeamFrag5) / 5.0;
